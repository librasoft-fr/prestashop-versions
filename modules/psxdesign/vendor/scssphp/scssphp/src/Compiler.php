...
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\AtRootBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\CallableBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\DirectiveBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\EachBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\ElseBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\ElseifBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\ForBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\IfBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\MediaBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\NestedPropertyBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\WhileBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\CachedResult;
...
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\ParserException;
...
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\Compressed;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\Expanded;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Logger\LoggerInterface;
use PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Logger\StreamLogger;
...
class Compiler
{
    ...
    public static $true = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'true'];
    public static $false = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'false'];
    /** @deprecated */
    public static $NaN = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'NaN'];
    /** @deprecated */
    public static $Infinity = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'Infinity'];
    public static $null = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NULL];
    public static $nullString = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', []];
    public static $defaultValue = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, ''];
    public static $selfSelector = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_SELF];
    public static $emptyList = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, '', []];
    public static $emptyMap = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP, [], []];
    public static $emptyString = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '"', []];
    public static $with = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'with'];
    public static $without = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'without'];
    private static $emptyArgumentList = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, '', [], []];
    /**
     ...
     */
    protected $registeredFeatures = ['extend-selector-pseudoclass' => \false, 'at-error' => \true, 'units-level-3' => \true, 'global-variable-shadowing' => \false];
    /**
     * @var string|null
     */
     ...
     */
    private $configuredFormatter = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\Expanded::class;
    /**
     * @var Environment
     */
    protected $rootEnv;
     ...
     * @var bool
     */
    private $legacyCwdImportPath = \true;
    /**
     * @var LoggerInterface
     */
    private $logger;
    ...
    public function __construct($cacheOptions = null)
    {
        $this->sourceNames = [];
        if ($cacheOptions) {
            $this->cache = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Cache($cacheOptions);
            if (!empty($cacheOptions['checkImportResolutions'])) {
                $this->cacheCheckImportResolutions = \true;
            }
        }
        $this->logger = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Logger\StreamLogger(\fopen('php://stderr', 'w'), \true);
    }
    /**
    ...
    {
        $options = ['importPaths' => $this->importPaths, 'registeredVars' => $this->registeredVars, 'registeredFeatures' => $this->registeredFeatures, 'encoding' => $this->encoding, 'sourceMap' => \serialize($this->sourceMap), 'sourceMapOptions' => $this->sourceMapOptions, 'formatter' => $this->configuredFormatter, 'legacyImportPath' => $this->legacyCwdImportPath];
        return $options;
    }
    /**
     ...
     * @return void
     */
    public function setLogger(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Logger\LoggerInterface $logger)
    {
        $this->logger = $logger;
    }
    /**
    ...
    {
        @\trigger_error('The method "setErrorOuput" is deprecated. Use "setLogger" instead.', \E_USER_DEPRECATED);
        $this->logger = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Logger\StreamLogger($handle);
    }
    /**
     * Compile scss
     *
    ...
    {
        @\trigger_error(\sprintf('The "%s" method is deprecated. Use "compileString" instead.', __METHOD__), \E_USER_DEPRECATED);
        $result = $this->compileString($code, $path);
        $sourceMap = $result->getSourceMap();
        if ($sourceMap !== null) {
            if ($this->sourceMap instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\SourceMap\SourceMapGenerator) {
                $this->sourceMap->saveMap($sourceMap);
            } elseif ($this->sourceMap === self::SOURCE_MAP_FILE) {
                $sourceMapGenerator = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\SourceMap\SourceMapGenerator($this->sourceMapOptions);
    ...
    public function compileString($source, $path = null)
    {
        if ($this->cache) {
            ...
            if ($cachedResult instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\CachedResult && $this->isFreshCachedResult($cachedResult)) {
        ...
        try {
            ...
            $previousWarnCallback = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Warn::setCallback($warnCallback);
            try {
                $this->injectVariables($this->registeredVars);
                $this->compileRoot($tree);
                $this->popEnv();
            } finally {
                \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Warn::setCallback($previousWarnCallback);
            }
            $sourceMapGenerator = null;
            if ($this->sourceMap) {
                if (\is_object($this->sourceMap) && $this->sourceMap instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\SourceMap\SourceMapGenerator) {
            ...
            $prefix = '';
            if ($this->charset && \strlen($out) !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbStrlen($out)) {
            ...
            if (!empty($out) && $this->sourceMap && $this->sourceMap !== self::SOURCE_MAP_NONE) {
                ...
                switch ($this->sourceMap) {
                    case self::SOURCE_MAP_INLINE:
                        $sourceMapUrl = \sprintf('data:application/json,%s', \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::encodeURIComponent($sourceMap));
                        break;
            ...
            throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\CompilerException($this->addLocationToMessage($e->getMessage()), 0, $e);
        }
        $includedFiles = [];
        foreach ($this->resolvedImports as $resolvedImport) {
            $includedFiles[$resolvedImport['filePath']] = $resolvedImport['filePath'];
        }
        $result = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\CompilationResult($out, $sourceMap, \array_values($includedFiles));
        if ($this->cache && isset($cacheKey) && isset($compileOptions)) {
            $this->cache->setCache('compile', $cacheKey, new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\CachedResult($result, $this->parsedFiles, $this->resolvedImports), $compileOptions);
        }
     ...
     * @return bool
     */
    private function isFreshCachedResult(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\CachedResult $result)
    {
    ...
    protected function parserFactory($path)
    {
        ...
        $parser = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser($path, \count($this->sourceNames), $this->encoding, $this->cache, $cssOnly, $this->logger);
    ...
    {
        $out = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock();
        $out->type = $type;
        $out->lines = [];
        $out->children = [];
        ...
        if ($this->env->block instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block) {
     ...
     * @return void
     */
    protected function compileRoot(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block $rootBlock)
    {
        $this->rootBlock = $this->scope = $this->makeOutputBlock(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ROOT);
    ...
    protected function missingSelectors()
    {
        foreach ($this->extends as $extend) {
            ...
            $this->sourceLine = $block[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_LINE];
     ...
     * @return void
     */
    protected function flattenSelectors(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $block, $parentKey = null)
    {
        if ($block->selectors) {
            $selectors = [];
     ...
     * @return void
     */
    protected function matchExtends($selector, &$out, $from = 0, $initial = \true)
    {
        static $partsPile = [];
            ...
            if ($this->matchExtendsSingle($part, $origin, $initial)) {
                ...
                foreach ($origin as $new) {
                    ...
                    if (!empty($before) && \count($new) > 1) {
                        ...
                        $result2 = \array_merge($preSharedParts, $betweenSharedParts, $postSharedParts, $nonBreakabl2, $nonBreakableBefore, $replacement, $after);
     ...
     * @return bool
     */
    protected function matchExtendsSingle($rawSingle, &$outOrigin, $initial = \true)
    {
        $counts = [];
        $single = [];
     ...
     * @return void
     */
    protected function compileMedia(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block $media)
    {
        \assert($media instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\MediaBlock);
        $this->pushEnv($media);
        ...
        if (!empty($mediaQueries)) {
            ...
            foreach ($mediaQueries as $mediaQuery) {
                $this->scope = $this->makeOutputBlock(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA, [$mediaQuery]);
            ...
            foreach ($media->children as $child) {
                $type = $child[0];
                if ($type !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_BLOCK && $type !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA && $type !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_DIRECTIVE && $type !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_IMPORT) {
                    $needsWrap = \true;
                    break;
                }
            }
            if ($needsWrap) {
                $wrapped = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block();
                ...
                $media->children = [[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_BLOCK, $wrapped]];
            }
     ...
     * @return \ScssPhp\ScssPhp\Formatter\OutputBlock
     */
    protected function mediaParent(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $scope)
    {
        while (!empty($scope->parent)) {
            if (!empty($scope->type) && $scope->type !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA) {
                break;
            }
            $scope = $scope->parent;
        }
     ...
     * @return void
     */
    protected function compileDirective($directive, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $out)
    {
        if (\is_array($directive)) {
            ...
            if (empty($directive[3])) {
                $this->appendRootDirective($s . ';' . $appendNewLine, $out, [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COMMENT, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_DIRECTIVE]);
            } else {
                $this->appendOutputLine($out, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_DIRECTIVE, $s . ';');
            }
        } else {
     ...
     * @return void
     */
    protected function compileAtRoot(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block $block)
    {
        \assert($block instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\AtRootBlock);
        ...
        if ($block->selector) {
            ...
            $block->children = [[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_BLOCK, $wrapped]];
            $block->selector = null;
        }
        $selfParent = $block->selfParent;
        \assert($selfParent !== null, 'at-root blocks must have a selfParent set.');
        if (!$selfParent->selectors && isset($block->parent) && isset($block->parent->selectors) && $block->parent->selectors) {
    ...
    protected function filterScopeWithWithout($scope, $with, $without)
    {
        $filteredScopes = [];
        $childStash = [];
        if ($scope->type === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ROOT) {
            return $scope;
        }
        \assert($this->rootBlock !== null);
        // start from the root
        while ($scope->parent && $scope->parent->type !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ROOT) {
        ...
        for (;;) {
            ...
            if ($this->isWith($scope, $with, $without)) {
                ...
                $s->lines = [];
                $s->parent = null;
                if ($s->type !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA && $s->type !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_DIRECTIVE) {
                    $s->selectors = [];
                }
                $filteredScopes[] = $s;
            }
    ...
    protected function compileWith($withCondition)
    {
        ...
        $without = ['rule' => \true];
        if ($withCondition) {
            if ($withCondition[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INTERPOLATE) {
    ...
    {
        if (isset($block->type)) {
            if ($block->type === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA) {
                return $this->testWithWithout('media', $with, $without);
            }
            if ($block->type === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_DIRECTIVE) {
                \assert($block instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\DirectiveBlock || $block instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock);
                if (isset($block->name)) {
            ...
            if (\count($block->selectors)) {
                ...
                if (\is_object($s) && $s instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
    ...
    protected function testWithWithout($what, $with, $without)
    {
        ...
        if (\count($without)) {
            return isset($without[$what]) || isset($without['all']) ? \false : \true;
        }
        // otherwise reject all what is not in the with list
        return isset($with[$what]) || isset($with['all']) ? \true : \false;
    }
    /**
     ...
     * @return void
     */
    protected function compileKeyframeBlock(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block $block, $selectors)
    {
        $env = $this->pushEnv($block);
        $envs = $this->compactEnv($env);
        $this->env = $this->extractEnv(\array_filter($envs, function (\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment $e) {
     ...
     * @return void
     */
    protected function compileNestedPropertiesBlock(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block $block, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $out)
    {
        \assert($block instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\NestedPropertyBlock);
        ...
        foreach ($block->children as $child) {
            switch ($child[0]) {
                case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ASSIGN:
                    \array_unshift($child[1][2], $prefix);
                    break;
                case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NESTED_PROPERTY:
                    \assert($child[1] instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\NestedPropertyBlock);
     ...
     * @return void
     */
    protected function compileNestedBlock(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block $block, $selectors)
    {
        $this->pushEnv($block);
        $this->scope = $this->makeOutputBlock($block->type, $selectors);
        \assert($this->scope->parent !== null);
        ...
        if (!$block instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\DirectiveBlock || $this->compileDirectiveName($block->name) !== 'font-face') {
            // need wrapping?
            $needWrapping = \false;
            foreach ($block->children as $child) {
                if ($child[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ASSIGN) {
                    $needWrapping = \true;
                    break;
                }
            }
     ...
     * @return void
     */
    protected function compileBlock(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block $block)
    {
        $env = $this->pushEnv($block);
    ...
    protected function compileCommentValue($value, $pushEnv = \false)
    {
        ...
        if (isset($value[2])) {
            ...
            try {
                ...
                $this->logger->warn('Ignoring interpolation errors in multiline comments is deprecated and will be removed in ScssPhp 2.0. ' . $this->addLocationToMessage($e->getMessage()), \true);
                ...
                $this->logger->warn('Ignoring interpolation errors in multiline comments is deprecated and will be removed in ScssPhp 2.0. ' . $e->getMessage(), \true);
                // ignore error in comment compilation which are only interpolation
            }
            if ($pushEnv) {
                $this->popEnv();
    ...
    {
        $out = $this->makeOutputBlock(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COMMENT);
        $out->lines[] = $this->compileCommentValue($block, \true);
        \assert($this->scope !== null);
        $this->scope->children[] = $out;
    }
    /**
    ...
    protected function evalSelectors($selectors)
    {
        ...
        if ($this->shouldEvaluate) {
            ...
            $parser = $this->parserFactory(__METHOD__);
            try {
                $isValid = $parser->parseSelector($buffer, $newSelectors, \true);
            } catch (\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\ParserException $e) {
    ...
    {
        foreach ($part as &$p) {
            if (\is_array($p) && ($p[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INTERPOLATE || $p[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING)) {
                $p = $this->compileValue($p);
                // force re-evaluation if self char or non standard char
                if (\preg_match(',[^\\w-],', $p)) {
                    $this->shouldEvaluate = \true;
                }
    ...
    protected function collapseSelectors($selectors)
    {
        ...
        foreach ($selectors as $selector) {
            ...
            foreach ($selector as $node) {
                $compound = '';
                \array_walk_recursive($node, function ($value, $key) use(&$compound) {
                    $compound .= $value;
                });
                $output[] = $compound;
            }
    ...
    private function collapseSelectorsAsList($selectors)
    {
        ...
        foreach ($selectors as $selector) {
            ...
            foreach ($output as &$o) {
                $o = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$o]];
            }
            $parts[] = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ' ', $output];
        }
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', $parts];
    }
    /**
    ...
    protected function replaceSelfSelector($selectors, $replace = null)
    {
        foreach ($selectors as &$part) {
            if (\is_array($part)) {
                if ($part === [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_SELF]) {
                    if (\is_null($replace)) {
                        $replace = $this->reduce([\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_SELF]);
    ...
    protected function compileSelectorPart($piece)
    {
        foreach ($piece as &$p) {
            ...
            switch ($p[0]) {
                case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_SELF:
                    $p = '&';
                    break;
                default:
                    $p = $this->compileValue($p);
    ...
    {
        $this->callStack[] = ['n' => $name, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_INDEX => $this->sourceIndex, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_LINE => $this->sourceLine, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_COLUMN => $this->sourceColumn];
        // infinite calling loop
        if (\count($this->callStack) > 25000) {
            // not displayed but you can var_dump it to deep debug
            $msg = $this->callStackMessage(\true, 100);
     ...
     */
    protected function compileChildren($stms, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $out, $traceName = '')
    {
     ...
     * @throws \Exception
     */
    protected function compileChildrenNoReturn($stms, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $out, $selfParent = null, $traceName = '')
    {
        $this->pushCallStack($traceName);
        foreach ($stms as $stm) {
            if ($selfParent && isset($stm[1]) && \is_object($stm[1]) && $stm[1] instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block) {
                $oldSelfParent = $stm[1]->selfParent;
                $stm[1]->selfParent = $selfParent;
                $ret = $this->compileChild($stm, $out);
                $stm[1]->selfParent = $oldSelfParent;
            } elseif ($selfParent && \in_array($stm[0], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INCLUDE, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_EXTEND])) {
        ...
        foreach ($queryList as $kql => $query) {
            ...
            foreach ($query as $kq => $q) {
                for ($i = 1; $i < \count($q); $i++) {
                    ...
                    if ($q[0] == \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA_TYPE && (\strpos($value, '(') !== \false || \strpos($value, ')') !== \false || \strpos($value, ':') !== \false || \strpos($value, ',') !== \false)) {
                        $shouldReparse = \true;
                    }
                    $queryList[$kql][$kq][$i] = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, $value];
                }
            }
            if ($shouldReparse) {
                if (\is_null($parser)) {
    ...
    protected function compileMediaQuery($queryList)
    {
        ...
        foreach ($queryList as $query) {
            ...
            $mediaTypeOnly = \true;
            foreach ($query as $q) {
                if ($q[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA_TYPE) {
                    $mediaTypeOnly = \false;
                    break;
                }
            }
            foreach ($query as $q) {
                switch ($q[0]) {
                    case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA_TYPE:
                        ...
                        if (!$mediaTypeOnly) {
                            if (\in_array(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NOT, $newType) || $type && \in_array(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NOT, $type)) {
                                if ($type) {
                        ...
                        if ($newType !== ['all']) {
                            if ($type) {
                                ...
                                if (empty($type)) {
                                    ...
                                    $parts = [];
                                    $default = '';
                                    // if everything fail, no @media at all
                                    continue 3;
                                }
                            } else {
                                $type = $newType;
                        ...
                        break;
                    case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA_EXPRESSION:
                        if (isset($q[2])) {
                        ...
                        break;
                    case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA_VALUE:
                        $parts[] = $this->compileValue($q[1]);
                        break;
                }
            }
    ...
    protected function mergeMediaTypes($type1, $type2)
    {
        ...
        if ($m1 === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NOT ^ $m2 === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NOT) {
            if ($t1 === $t2) {
                return null;
            }
            return [$m1 === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NOT ? $m2 : $m1, $m1 === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NOT ? $t2 : $t1];
        }
        if ($m1 === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NOT && $m2 === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NOT) {
            ...
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NOT, $t1];
        }
        if ($t1 !== $t2) {
            return null;
        }
     ...
     * @return bool
     */
    protected function compileImport($rawPath, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $out, $once = \false)
    {
        if ($rawPath[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING) {
        ...
        if ($rawPath[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST) {
            // handle a list of strings
            if (\count($rawPath[2]) === 0) {
                return \false;
            }
            foreach ($rawPath[2] as $path) {
                if ($path[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING) {
                    $this->appendRootDirective('@import ' . $this->compileImportPath($rawPath) . ';', $out);
                    return \false;
                }
            }
    ...
    {
        switch ($path[0]) {
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST:
                foreach ($path[2] as $k => $v) {
                    $path[2][$k] = $this->escapeImportPathString($v);
                }
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING:
                if ($path[1]) {
                    $path = $this->compileValue($path);
                    $path = \str_replace(' ', '\\ ', $path);
                    $path = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, $path];
                }
                break;
        }
        return $path;
     ...
     * @return void
     */
    protected function appendRootDirective($line, $out, $allowed = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COMMENT])
    {
        $root = $out;
        while ($root->parent) {
            $root = $root->parent;
        ...
        $child = $this->makeOutputBlock(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COMMENT);
        $child->lines[] = $line;
     ...
     * @return void
     */
    protected function appendOutputLine(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $out, $type, $line)
    {
        $outWrite =& $out;
     ...
     * @return array|Number|null
     */
    protected function compileChild($child, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $out)
    {
        if (isset($child[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_LINE])) {
            $this->sourceIndex = isset($child[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_INDEX]) ? $child[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_INDEX] : null;
            $this->sourceLine = isset($child[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_LINE]) ? $child[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_LINE] : -1;
            $this->sourceColumn = isset($child[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_COLUMN]) ? $child[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_COLUMN] : -1;
        } elseif (\is_array($child) && isset($child[1]->sourceLine) && $child[1] instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block) {
        ...
        switch ($child[0]) {
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_SCSSPHP_IMPORT_ONCE:
                $rawPath = $this->reduce($child[1]);
                $this->compileImport($rawPath, $out, \true);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_IMPORT:
                $rawPath = $this->reduce($child[1]);
                $this->compileImport($rawPath, $out);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_DIRECTIVE:
                $this->compileDirective($child[1], $out);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_AT_ROOT:
                $this->compileAtRoot($child[1]);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA:
                $this->compileMedia($child[1]);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_BLOCK:
                $this->compileBlock($child[1]);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_CHARSET:
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_CUSTOM_PROPERTY:
                list(, $name, $value) = $child;
                $compiledName = $this->compileValue($name);
                // if the value reduces to null from something else then
                // the property should be discarded
                if ($value[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NULL) {
                    $value = $this->reduce($value);
                    if ($value[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NULL || $value === static::$nullString) {
                        break;
                    }
                }
                $compiledValue = $this->compileValue($value);
                $line = $this->formatter->customProperty($compiledName, $compiledValue);
                $this->appendOutputLine($out, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ASSIGN, $line);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ASSIGN:
                list(, $name, $value) = $child;
                if ($name[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_VARIABLE) {
                    ...
                    $shouldSet = $isDefault && (\is_null($result = $this->get($name[1], \false)) || $result === static::$null);
                    if (!$isDefault || $shouldSet) {
                        $this->set($name[1], $this->reduce($value), \true, null, $value);
                    }
                    break;
                }
                $compiledName = $this->compileValue($name);
                ...
                if (\in_array($compiledName, ['font', 'grid-row', 'grid-column', 'border-radius'])) {
                    if ($value[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_VARIABLE) {
                        ...
                        $value = $this->get($value[1], \true, null, \true);
                    }
                    ...
                    switch ($compiledName) {
                        case 'border-radius':
                            $maxListElements = 4;
                            $shorthandDividerNeedsUnit = \true;
                            break;
                    }
                    if ($compiledName === 'font' && $value[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST && $value[1] === ',') {
                    ...
                    if ($shorthandValue[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_EXPRESSION && $shorthandValue[1] === '/') {
                        $revert = \true;
                        if ($shorthandDividerNeedsUnit) {
                            $divider = $shorthandValue[3];
                            if (\is_array($divider)) {
                                $divider = $this->reduce($divider, \true);
                            }
                            if ($divider instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number && \intval($divider->getDimension()) && $divider->unitless()) {
                                $revert = \false;
                            }
                        }
                        if ($revert) {
                    ...
                    } elseif ($shorthandValue[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST) {
                        foreach ($shorthandValue[2] as &$item) {
                            if ($item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_EXPRESSION && $item[1] === '/') {
                ...
                if (\strlen($compiledValue)) {
                    $line = $this->formatter->property($compiledName, $compiledValue);
                    $this->appendOutputLine($out, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ASSIGN, $line);
                }
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COMMENT:
                if ($out->type === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ROOT) {
                    $this->compileComment($child);
                    break;
                }
                $line = $this->compileCommentValue($child, \true);
                $this->appendOutputLine($out, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COMMENT, $line);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MIXIN:
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION:
                list(, $block) = $child;
                \assert($block instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\CallableBlock);
                // the block need to be able to go up to it's parent env to resolve vars
                $block->parentEnv = $this->getStoreEnv();
                $this->set(static::$namespaces[$block->type] . $block->name, $block, \true);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_EXTEND:
...
EOL;
                ...
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_IF:
                list(, $if) = $child;
                \assert($if instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\IfBlock);
                if ($this->isTruthy($this->reduce($if->cond, \true))) {
                    return $this->compileChildren($if->children, $out);
                }
                foreach ($if->cases as $case) {
                    if ($case instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\ElseBlock || $case instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\ElseifBlock && $this->isTruthy($this->reduce($case->cond))) {
                        return $this->compileChildren($case->children, $out);
                    }
                }
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_EACH:
                list(, $each) = $child;
                \assert($each instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\EachBlock);
                $list = $this->coerceList($this->reduce($each->list), ',', \true);
                $this->pushEnv();
                foreach ($list[2] as $item) {
                    if (\count($each->vars) === 1) {
                        $this->set($each->vars[0], $item, \true);
                    } else {
                        list(, , $values) = $this->coerceList($item);
                        foreach ($each->vars as $i => $var) {
                            $this->set($var, isset($values[$i]) ? $values[$i] : static::$null, \true);
                        }
                    }
                ...
                $this->backPropagateEnv($store, $each->vars);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_WHILE:
                list(, $while) = $child;
                \assert($while instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\WhileBlock);
                while ($this->isTruthy($this->reduce($while->cond, \true))) {
                ...
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FOR:
                list(, $for) = $child;
                \assert($for instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\ForBlock);
                $startNumber = $this->assertNumber($this->reduce($for->start, \true));
                $endNumber = $this->assertNumber($this->reduce($for->end, \true));
                ...
                for (;;) {
                    ...
                    $this->set($for->var, new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number($start, $numeratorUnits, $denominatorUnits));
                    $start += $d;
                ...
                $this->backPropagateEnv($store, [$for->var]);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_RETURN:
                return $this->reduce($child[1], \true);
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NESTED_PROPERTY:
                $this->compileNestedPropertiesBlock($child[1], $out);
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INCLUDE:
                // including a mixin
                ...
                \assert($mixin instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\CallableBlock);
                ...
                $selfParent = null;
                if (isset($child['selfParent']) && $child['selfParent'] instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block && isset($child['selfParent']->selectors)) {
                    $selfParent = $child['selfParent'];
                } else {
                    $parentSelectors = $this->multiplySelectors($this->env);
                    if ($parentSelectors) {
                        $parent = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block();
                        $parent->selectors = $parentSelectors;
                        foreach ($mixin->children as $k => $child) {
                            if (isset($child[1]) && $child[1] instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block) {
                ...
                $this->popEnv();
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MIXIN_CONTENT:
                ...
                foreach ($varsUsing as $name => $val) {
                    $this->set($name, $val, \true, $this->storeEnv);
                }
                $this->compileChildrenNoReturn($content->children, $out);
                $this->storeEnv = $storeEnv;
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_DEBUG:
                list(, $value) = $child;
                $fname = $this->getPrettyPath($this->sourceNames[$this->sourceIndex]);
                $line = $this->sourceLine;
                ...
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_WARN:
                list(, $value) = $child;
                $fname = $this->getPrettyPath($this->sourceNames[$this->sourceIndex]);
                $line = $this->sourceLine;
                $value = $this->compileDebugValue($value);
                ...
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_ERROR:
                list(, $value) = $child;
                $fname = $this->getPrettyPath($this->sourceNames[$this->sourceIndex]);
                $line = $this->sourceLine;
                $value = $this->compileValue($this->reduce($value, \true));
    ...
    protected function expToString($exp, $keepParens = \false)
    {
        ...
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', $content];
    }
    /**
     * Is truthy?
     *
    ...
    {
        switch ($value[0]) {
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_EXPRESSION:
                if ($value[1] === '/') {
                    return $this->shouldEval($value[2]) || $this->shouldEval($value[3]);
                }
            // fall-thru
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_VARIABLE:
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_CALL:
                return \true;
        }
        return \false;
    }
    ...
    protected function reduce($value, $inExp = \false)
    {
        ...
        switch ($value[0]) {
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_EXPRESSION:
                ...
                $left = $this->reduce($left, \true);
                if ($op !== 'and' && $op !== 'or') {
                    $right = $this->reduce($right, \true);
                }
                // special case: looks like css shorthand
                if ($opName == 'div' && !$inParens && !$inExp && ($right[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NUMBER && isset($right[2]) && $right[2] != '' || $right[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NUMBER && !$right->unitless())) {
                ...
                return $this->expToString($value);
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_UNARY:
                list(, $op, $exp, $inParens) = $value;
                $inExp = $inExp || $this->shouldEval($exp);
                $exp = $this->reduce($exp);
                if ($exp instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
                    switch ($op) {
                        case '+':
                            return $exp;
                        case '-':
                ...
                return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$op, $exp]];
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_VARIABLE:
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST:
                ...
                return $value;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP:
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING:
                foreach ($value[2] as &$item) {
                    if (\is_array($item) || $item instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
                        $item = $this->reduce($item);
                    }
                }
                return $value;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INTERPOLATE:
                $value[1] = $this->reduce($value[1]);
                if ($inExp) {
                    return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, $this->compileValue($value, \false)];
                }
                return $value;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_CALL:
    ...
    protected function fncall($functionReference, $argValues)
    {
        ...
        if (\is_string($functionReference)) {
            ...
            if ($functionReference === static::$null || $functionReference[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_REFERENCE) {
                $functionReference = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION, $name, [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', []]];
            }
        }
        // a function type means we just want a plain css function call
        if ($functionReference[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION) {
            ...
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION, $functionReference[1], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', $listArgs]];
        }
        if ($functionReference === static::$null || $functionReference[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_REFERENCE) {
        ...
        switch ($functionReference[1]) {
            ...
            case 'native':
                ...
                if (\in_array($name, ['min', 'max']) && \count($argValues) >= 1) {
                    $cssFunction = $this->cssValidArg([\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_CALL, $name, $argValues], ['min', 'max', 'calc', 'env', 'var']);
                ...
                if (!isset($returnValue)) {
                    return $this->fncall([\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION, $name, [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', []]], $argValues);
                }
                return $returnValue;
            default:
                return static::$defaultValue;
    ...
    {
        if ($arg instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            return $this->stringifyFncallArgs($arg);
        }
        switch ($arg[0]) {
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INTERPOLATE:
                return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, $this->CompileValue($arg)];
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION:
                if (!\in_array($arg[1], $allowed_function)) {
                    return \false;
                }
                if ($arg[2][0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST) {
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_CALL:
                ...
                return $this->fncall([\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION, $arg[1], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', []]], $cssArgs);
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING:
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD:
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST:
                ...
                if (empty($arg['enclosing']) and $arg[1] === '') {
                    ...
                    $arg[0] = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING;
                    return $arg;
                }
                return \false;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_EXPRESSION:
                ...
                return $this->expToString($arg, \true);
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_VARIABLE:
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_SELF:
            default:
                return \false;
        ...
        switch ($arg[0]) {
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_CALL:
                ...
                if (\in_array($name, ['max', 'min', 'calc'])) {
                    $args = $arg[2];
                    $arg = $this->fncall([\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION, $name, [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', []]], $args);
                }
                break;
        }
        return $arg;
    ...
    protected function getFunctionReference($name, $safeCopy = \false)
    {
        ...
        if ($func = $this->get(static::$namespaces['function'] . $name, \false)) {
            ...
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_REFERENCE, 'scss', $name, $func];
        }
        // native PHP functions
        ...
        if (isset($this->userFunctions[$normalizedName])) {
            ...
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_REFERENCE, 'user', $name, $f, $prototype];
        }
        ...
        if (($f = $this->getBuiltinFunction($normalizedName)) && \is_callable($f)) {
            ...
            if ($prototype === null || \strtolower($normalizedName) !== $normalizedName) {
                ...
                if ($actualLibName !== $libName || \strtolower($normalizedName) !== $normalizedName) {
                    ...
                    $fname = $this->getPrettyPath($this->sourceNames[$this->sourceIndex]);
                    $line = $this->sourceLine;
                    \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Warn::deprecation("{$warning}\n         on line {$line} of {$fname}");
            ...
            if (\get_class($this) !== __CLASS__ && !isset($this->warnedChildFunctions[$libName])) {
                ...
                if ($needsWarning) {
                    if (\method_exists(__CLASS__, $libName)) {
                        @\trigger_error(\sprintf('Overriding the "%s" core function by extending the Compiler is deprecated and will be unsupported in 2.0. Remove the "%s::%s" method.', $normalizedName, $declaringClass, $libName), \E_USER_DEPRECATED);
                    } else {
                        @\trigger_error(\sprintf('Registering custom functions by extending the Compiler and using the lib* discovery mechanism is deprecated and will be removed in 2.0. Replace the "%s::%s" method with registering the "%s" function through "Compiler::registerFunction".', $declaringClass, $libName, $normalizedName), \E_USER_DEPRECATED);
                    }
                }
            }
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_REFERENCE, 'native', $name, $f, $prototype];
        }
        return static::$null;
    }
    /**
    ...
    public function normalizeValue($value)
    {
        ...
        switch ($value[0]) {
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST:
                ...
                if ($value[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST) {
                    return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, $this->compileValue($value)];
                }
     ...
     * @return Number
     */
    protected function opAddNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
     ...
     * @return Number
     */
    protected function opMulNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
     ...
     * @return Number
     */
    protected function opSubNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
     ...
     * @return Number
     */
    protected function opDivNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
     ...
     * @return Number
     */
    protected function opModNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
    ...
    protected function opAdd($left, $right)
    {
        if ($strLeft = $this->coerceString($left)) {
            if ($right[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING) {
                $right[1] = '';
            }
            $strLeft[2][] = $right;
            return $strLeft;
        ...
        if ($strRight = $this->coerceString($right)) {
            if ($left[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING) {
                $left[1] = '';
            }
    ...
    {
        $truthy = $left === static::$null || $right === static::$null || ($left === static::$false || $left === static::$true) && ($right === static::$false || $right === static::$true);
        if (!$shouldEval) {
            if (!$truthy) {
                return null;
            }
    ...
    protected function opColorColor($op, $left, $right)
    {
        ...
        $out = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR];
        foreach ([1, 2, 3] as $i) {
     ...
     * @return array
     */
    protected function opColorNumber($op, $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
        if ($op === '==') {
            return static::$false;
        }
        ...
        return $this->opColorColor($op, $left, [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR, $value, $value, $value]);
    }
    /**
     ...
     * @return array
     */
    protected function opNumberColor($op, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, $right)
    {
        if ($op === '==') {
            return static::$false;
        }
        ...
        return $this->opColorColor($op, [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR, $value, $value, $value], $right);
    }
    /**
     ...
     * @return array
     */
    protected function opEqNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
     ...
     * @return array
     */
    protected function opNeqNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
        return $this->toBool(!$left->equals($right));
    }
    /**
     ...
     * @return array
     */
    protected function opGteNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
     ...
     * @return array
     */
    protected function opGtNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
     ...
     * @return array
     */
    protected function opLteNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
     ...
     * @return array
     */
    protected function opLtNumberNumber(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $left, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number $right)
    {
    ...
    public function escapeNonPrintableChars($string, $inKeyword = \false)
    {
        ...
        if (\strpos($string, \chr(0)) !== \false) {
            ...
            $string = \str_replace([\chr(0) . '\\', \chr(0) . ' '], ['\\', ' '], $string);
            if (\strpos($string, \chr(0)) !== \false) {
     ...
     * @return string
     */
    public function compileValue($value, $quote = \true)
    {
        $value = $this->reduce($value);
        if ($value instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
        ...
        switch ($value[0]) {
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD:
                return $this->escapeNonPrintableChars($value[1], \true);
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR:
                ...
                if (\count($value) === 5) {
                    $alpha = $this->compileRGBAValue($value[4], \true);
                    if (!\is_numeric($alpha) || $alpha < 1) {
                        $colorName = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Colors::RGBaToColorName($r, $g, $b, $alpha);
                        if (!\is_null($colorName)) {
                            return $colorName;
                        }
                        if (\is_numeric($alpha)) {
                            $a = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number($alpha, '');
                        } else {
                            $a = $alpha;
                        }
                        return 'rgba(' . $r . ', ' . $g . ', ' . $b . ', ' . $a . ')';
                ...
                $colorName = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Colors::RGBaToColorName($r, $g, $b);
                if (!\is_null($colorName)) {
                    return $colorName;
                }
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING:
                ...
                if ($value[1] && $quote) {
                    ...
                    if ($value[1] === "'" && (\strpos($content, '"') === \false or \strpos($content, "'") !== \false)) {
                        $value[1] = '"';
                    } elseif ($value[1] === '"' && (\strpos($content, '"') !== \false and \strpos($content, "'") === \false)) {
                        $value[1] = "'";
                    }
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION:
                ...
                return "{$value[1]}({$args})";
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_REFERENCE:
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST:
                ...
                foreach ($items as $item) {
                    if (\is_null($same_string_quote)) {
                        ...
                        if ($item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING) {
                            $same_string_quote = $item[1];
                            foreach ($items as $ii) {
                                if ($ii[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING) {
                                    $same_string_quote = \false;
                                    break;
                                }
                            }
                    ...
                    if ($item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NULL) {
                        continue;
                    }
                    if ($same_string_quote === '"' && $item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING && $item[1]) {
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INTERPOLATED:
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INTERPOLATE:
                ...
                if ($reduced instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
                    return $this->compileValue($reduced, $quote);
                }
                switch ($reduced[0]) {
                    case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST:
                        $reduced = $this->extractInterpolation($reduced);
                        if ($reduced[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST) {
                            break;
                        }
                        ...
                        foreach ($items as $item) {
                            ...
                            } elseif ($item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD) {
                                $filtered[] = $item[1];
                            } else {
                                $filtered[] = $this->compileValue($item, $quote);
                            }
                        }
                        $reduced = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, \implode("{$delim}", $filtered)];
                        break;
                    case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING:
                        $reduced = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$this->compileStringContent($reduced)]];
                        break;
                    case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NULL:
                        $reduced = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, ''];
                }
                return $this->compileValue($reduced, $quote);
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NULL:
                return 'null';
    ...
    {
        @\trigger_error(\sprintf('The "%s" method is deprecated.', __METHOD__), \E_USER_DEPRECATED);
    ...
    {
        if ($value[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING) {
     ...
     * @return string
     */
    protected function compileStringContent($string, $quote = \true)
    {
        $parts = [];
        foreach ($string[2] as $part) {
            if (\is_array($part) || $part instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
    ...
    protected function extractInterpolation($list)
    {
        ...
        foreach ($items as $i => $item) {
            if ($item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INTERPOLATE) {
                $before = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, $list[1], \array_slice($items, 0, $i)];
                $after = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, $list[1], \array_slice($items, $i + 1)];
                return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INTERPOLATED, $item, $before, $after];
            }
        }
        return $list;
    }
     ...
     * @return array
     */
    protected function multiplySelectors(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment $env, $selfParent = null)
    {
        $envs = $this->compactEnv($env);
        $selectors = [];
        $parentSelectors = [[]];
     ...
     * @return array
     */
    protected function multiplyMedia(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment $env = null, $childQueries = null)
    {
        if (!isset($env) || !empty($env->block->type) && $env->block->type !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA) {
            return $childQueries;
        }
        ...
        \assert($env->block instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block\MediaBlock);
        $parentQueries = isset($env->block->queryList) ? $env->block->queryList : [[[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA_VALUE, $env->block->value]]];
        ...
        if (\is_null($childQueries)) {
            ...
            foreach ($parentQueries as $parentQuery) {
                foreach ($originalQueries as $childQuery) {
                    $childQueries[] = \array_merge($parentQuery, [[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MEDIA_TYPE, [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'all']]], $childQuery);
                }
            }
        }
        return $this->multiplyMedia($env->parent, $childQueries);
     ...
     */
    protected function compactEnv(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment $env)
    {
     ...
     */
    protected function pushEnv(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Block $block = null)
    {
        $env = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment();
        $env->parent = $this->env;
     ...
     * @return void
     */
    protected function set($name, $value, $shadow = \false, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment $env = null, $valueUnreduced = null)
    {
     ...
     * @return void
     */
    protected function setExisting($name, $value, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment $env, $valueUnreduced = null)
    {
        $storeEnv = $env;
     ...
     * @return void
     */
    protected function setRaw($name, $value, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment $env, $valueUnreduced = null)
    {
        $env->store[$name] = $value;
        if ($valueUnreduced) {
            $env->storeUnreduced[$name] = $valueUnreduced;
     ...
     * @return mixed|null
     */
    public function get($name, $shouldThrow = \true, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment $env = null, $unreduced = \false)
    {
        $normalizedName = $this->normalizeName($name);
        $specialContentKey = static::$namespaces['special'] . 'content';
        if (!isset($env)) {
     ...
     * @return bool
     */
    protected function has($name, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler\Environment $env = null)
    {
    ...
    public function addVariables(array $variables)
    {
        ...
        foreach ($variables as $name => $value) {
            if (!$value instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number && !\is_array($value)) {
                $triggerWarning = \true;
            }
            $this->registeredVars[$name] = $value;
        }
        if ($triggerWarning) {
            @\trigger_error('Passing raw values to as custom variables to the Compiler is deprecated. Use "\\ScssPhp\\ScssPhp\\ValueConverter::parseValue" or "\\ScssPhp\\ScssPhp\\ValueConverter::fromPhp" to convert them instead.', \E_USER_DEPRECATED);
        }
    }
    /**
     * Set variables
    ...
    {
        @\trigger_error('The method "setVariables" of the Compiler is deprecated. Use the "addVariables" method for the equivalent behavior or "replaceVariables" if merging with previous variables was not desired.');
        $this->addVariables($variables);
    }
    /**
     * Unset variable
    ...
    {
        @\trigger_error('The method "getParsedFiles" of the Compiler is deprecated. Use the "getIncludedFiles" method on the CompilationResult instance returned by compileString() instead. Be careful that the signature of the method is different.', \E_USER_DEPRECATED);
    ...
    public function setImportPaths($path)
    {
        ...
        if ($this->legacyCwdImportPath) {
            @\trigger_error('Passing an empty string in the import paths to refer to the current working directory is deprecated. If that\'s the intended behavior, the value of "getcwd()" should be used directly instead. If this was used for resolving relative imports of the input alongside "chdir" with the source directory, the path of the input file should be passed to "compileString()" instead.', \E_USER_DEPRECATED);
        }
    ...
    {
        @\trigger_error('The number precision is not configurable anymore. ' . 'The default is enough for all browsers.', \E_USER_DEPRECATED);
    }
    /**
    ...
    {
        switch ($style) {
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\OutputStyle::EXPANDED:
                $this->configuredFormatter = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\Expanded::class;
                break;
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\OutputStyle::COMPRESSED:
                $this->configuredFormatter = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\Compressed::class;
                break;
            default:
    ...
    {
        if (!\in_array($formatterName, [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\Expanded::class, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\Compressed::class], \true)) {
            @\trigger_error('Formatters other than Expanded and Compressed are deprecated.', \E_USER_DEPRECATED);
        }
        @\trigger_error('The method "setFormatter" is deprecated. Use "setOutputStyle" instead.', \E_USER_DEPRECATED);
    ...
    {
        @\trigger_error('The line number output is not supported anymore. ' . 'Use source maps instead.', \E_USER_DEPRECATED);
    }
    /**
    ...
    public function registerFunction($name, $callback, $argumentDeclaration = null)
    {
        if (self::isNativeFunction($name)) {
            @\trigger_error(\sprintf('The "%s" function is a core sass function. Overriding it with a custom implementation through "%s" is deprecated and won\'t be supported in ScssPhp 2.0 anymore.', $name, __METHOD__), \E_USER_DEPRECATED);
        }
        if ($argumentDeclaration === null) {
            @\trigger_error('Omitting the argument declaration when registering custom function is deprecated and won\'t be supported in ScssPhp 2.0 anymore.', \E_USER_DEPRECATED);
        }
    ...
    {
        @\trigger_error('Registering additional features is deprecated.', \E_USER_DEPRECATED);
        $this->registeredFeatures[$name] = \true;
    }
    /**
     * Import file
     *
     ...
     * @return void
     */
    protected function importFile($path, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock $out)
    {
    ...
    public function findImport($url, $currentDir = null)
    {
                ...
                if (\is_callable($dir)) {
                    ...
                    if (!\is_null($file)) {
                        if (\is_array($dir)) {
                            ...
                            $callableDescription = 'callable';
                            // Fallback if we don't have a dedicated description
                        }
                        @\trigger_error(\sprintf('Returning a file to import for CSS or external references in custom importer callables is deprecated and will not be supported anymore in ScssPhp 2.0. This behavior is not compliant with the Sass specification. Update your "%s" importer.', $callableDescription), \E_USER_DEPRECATED);
                        return $file;
                    }
                }
            }
        ...
        if ($this->legacyCwdImportPath) {
            ...
            if (!\is_null($path)) {
                @\trigger_error('Resolving imports relatively to the current working directory is deprecated. If that\'s the intended behavior, the value of "getcwd()" should be added as an import path explicitly instead. If this was used for resolving relative imports of the input alongside "chdir" with the source directory, the path of the input file should be passed to "compileString()" instead.', \E_USER_DEPRECATED);
                return $path;
            }
        }
    ...
    {
        $path = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util\Path::join($baseDir, $url);
    ...
    {
        $result = \array_merge($this->tryImportPath($path . '.sass'), $this->tryImportPath($path . '.scss'));
        if ($result) {
            return $result;
        }
    ...
    public function setEncoding($encoding)
    {
        if (!$encoding || \strtolower($encoding) === 'utf-8') {
            ...
            @\trigger_error(\sprintf('The "%s" method is deprecated. Parsing will only support UTF-8 in ScssPhp 2.0. The non-UTF-8 parsing of ScssPhp 1.x is not spec compliant.', __METHOD__), \E_USER_DEPRECATED);
        }
    ...
    {
        @\trigger_error('Ignoring Sass errors is not longer supported.', \E_USER_DEPRECATED);
        return $this;
    }
    /**
     * Get source position
    ...
    {
        @\trigger_error('The method "throwError" is deprecated. Use "error" and throw the exception in the caller instead', \E_USER_DEPRECATED);
    ...
    public function error($msg, ...$args)
    {
        ...
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\CompilerException($msg);
    }
    /**
     * @param string $msg
     *
    ...
    private function addLocationToMessage($msg)
    {
        ...
        $loc = isset($this->sourceNames[$this->sourceIndex]) ? $this->getPrettyPath($this->sourceNames[$this->sourceIndex]) . " on line {$line}, at column {$column}" : "line: {$line}, column: {$column}";
        $msg = "{$msg}: {$loc}";
        ...
        if ($this->callStack) {
            foreach (\array_reverse($this->callStack) as $call) {
                if ($all || isset($call['n']) && $call['n']) {
                    $msg = '#' . $ncall++ . ' ' . $call['n'] . ' ';
                    $msg .= isset($this->sourceNames[$call[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_INDEX]]) ? $this->getPrettyPath($this->sourceNames[$call[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_INDEX]]) : '(unknown file)';
                    $msg .= ' on line ' . $call[\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Parser::SOURCE_LINE];
                    $callStackMsg[] = $msg;
    ...
    protected function callScssFunction($func, $argValues)
    {
        ...
        $tmp = new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Formatter\OutputBlock();
        $tmp->lines = [];
        $tmp->children = [];
    ...
    protected function callNativeFunction($name, $function, $prototype, $args)
    {
        ...
        if (\is_array($returnValue) || $returnValue instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            return $returnValue;
        }
        @\trigger_error(\sprintf('Returning a PHP value from the "%s" custom function is deprecated. A sass value must be returned instead.', $name), \E_USER_DEPRECATED);
    ...
    {
        return \method_exists(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler::class, self::normalizeNativeFunctionName($name));
    }
    /**
    ...
    protected function sortNativeFunctionArgs($functionName, $prototypes, $args)
    {
        ...
        if (\in_array($functionName, ['libRgb', 'libRgba', 'libHsl', 'libHsla'])) {
            ...
            foreach ($args as $k => $arg) {
                if (!isset($arg[1])) {
                    continue;
                    // This happens when using a trailing comma
                }
                if ($arg[1][0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST && \count($arg[1][2]) === 3) {
        ...
        foreach ($matchedPrototype['arguments'] as $argument) {
            ...
            if ($value === [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'null']) {
                $value = null;
            }
            $finalArgs[] = $value;
    ...
    private function parseFunctionPrototype(array $prototype)
    {
        ...
        foreach ($prototype as $p) {
            ...
            if (isset($p[1])) {
                $defaultSource = \trim($p[1]);
                if ($defaultSource === 'null') {
                    // differentiate this null from the static::$null
                    $default = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'null'];
                } else {
                    if (\is_null($parser)) {
                        $parser = $this->parserFactory(__METHOD__);
                    }
    ...
    private function verifyPrototype(array $prototype, $positional, array $names, $hasSplat)
    {
        ...
        foreach ($prototype['arguments'] as $i => $argument) {
            ...
            if ($i < $positional) {
                if (isset($names[$name])) {
                    throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException(\sprintf('Argument $%s was passed both by position and by name.', $originalName));
                }
            } elseif (isset($names[$name])) {
                $nameUsed++;
            } elseif ($default === null) {
                throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException(\sprintf('Missing argument $%s', $originalName));
            }
        }
        if ($prototype['rest_argument'] !== null) {
            return;
        ...
        if ($positional > \count($prototype['arguments'])) {
            $message = \sprintf('Only %d %sargument%s allowed, but %d %s passed.', \count($prototype['arguments']), empty($names) ? '' : 'positional ', \count($prototype['arguments']) === 1 ? '' : 's', $positional, $positional === 1 ? 'was' : 'were');
            if (!$hasSplat) {
                throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException($message);
            }
            $message = $this->addLocationToMessage($message);
            $message .= "\nThis will be an error in future versions of Sass.";
            $this->logger->warn($message, \true);
        }
        if ($nameUsed < \count($names)) {
     ...
     */
    private function evaluateArguments(array $args, $reduce = \true)
    {
        ...
        foreach ($args as $arg) {
            if (!empty($arg[0])) {
                $hasKeywordArgument = \true;
                \assert(\is_string($arg[0][1]));
                $name = \str_replace('_', '-', $arg[0][1]);
                if (isset($keywordArgs[$name])) {
                    throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException(\sprintf('Duplicate named argument $%s.', $arg[0][1]));
                }
                $keywordArgs[$name] = $this->maybeReduce($reduce, $arg[1]);
                $names[$name] = $name;
            } elseif (!empty($arg[2])) {
                // $arg[2] means a var followed by ... in the arg ($list... )
                $val = $this->reduce($arg[1], \true);
                $hasSplat = \true;
                if ($val[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST) {
                    ...
                    if (isset($val[3]) && \is_array($val[3])) {
                        foreach ($val[3] as $name => $item) {
                            ...
                            if (isset($keywordArgs[$normalizedName])) {
                                throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException(\sprintf('Duplicate named argument $%s.', $name));
                            }
                ...
                } elseif ($val[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP) {
                ...
                } elseif ($val[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_NULL) {
                ...
                throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException('Positional arguments must come before keyword arguments.');
            } else {
     ...
     * @throws \Exception
     */
    protected function applyArguments($argDef, $argValues, $storeInEnv = \true, $reduce = \true)
    {
        $output = [];
        ...
        foreach ($prototype['arguments'] as $argument) {
            ...
            if ($storeInEnv) {
                $this->set($name, $this->reduce($val, \true), \true, $env);
            } else {
                $output[$name] = $reduce ? $this->reduce($val, \true) : $val;
            }
        }
        if ($prototype['rest_argument'] !== null) {
        ...
        foreach ($prototype['arguments'] as $argument) {
            ...
            \assert($default !== null);
            if ($storeInEnv) {
                $this->set($name, $this->reduce($default, \true), \true);
            } else {
                $output[$name] = $reduce ? $this->reduce($default, \true) : $default;
            }
        }
        return $output;
    }
    ...
    private function applyArgumentsToDeclaration(array $prototype, array $positionalArgs, array $namedArgs, $splatSeparator)
    {
        ...
        if ($prototype['rest_argument'] !== null) {
            ...
            $val = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, \is_null($splatSeparator) ? ',' : $splatSeparator, $rest, $restNamed];
            $output[$name] = $val;
        }
        return $output;
    }
    ...
    {
        if (\is_array($value) || $value instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            return $value;
        }
        if (\is_bool($value)) {
        ...
        $value = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, $value];
    ...
    {
        if ($item instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            return null;
        }
        if ($item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP) {
            return $item;
        }
        if ($item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST && $item[2] === []) {
    ...
    {
        if ($item instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, '', [$item]];
        }
        if ($item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST) {
        ...
        if ($item[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP) {
            ...
            for ($i = 0, $s = \count($keys); $i < $s; $i++) {
                $key = $keys[$i];
                $value = $values[$i];
                $list[] = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ' ', [$key, $value]];
            }
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, $list ? ',' : '', $list];
        }
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, '', [$item]];
    }
    /**
    ...
    protected function coerceColor($value, $inRGBFunction = \false)
    {
        ...
        switch ($value[0]) {
                ...
                for ($i = 1; $i <= 3; $i++) {
                    ...
                    if (isset($value[4])) {
                        if (!\is_numeric($value[4])) {
                            $cv = $this->compileRGBAValue($value[4], \true);
                            if (!\is_numeric($cv)) {
                                return null;
                            }
                            $value[4] = $cv;
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST:
                if ($inRGBFunction) {
                    if (\count($value[2]) == 3 || \count($value[2]) == 4) {
                        $color = $value[2];
                        \array_unshift($color, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR);
            ...
            case \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD:
                    ...
                    if (\in_array($nofValues, [3, 4, 6, 8])) {
                        ...
                        if ($nbChannels === 4) {
                            if ($color[3] === 255) {
                                ...
                                $color[3] = \round($color[3] / 255, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number::PRECISION);
                            }
                        }
                        \array_unshift($color, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR);
                        return $color;
                ...
                if ($rgba = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Colors::colorNameToRGBa($name)) {
                    return isset($rgba[3]) ? [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR, $rgba[0], $rgba[1], $rgba[2], $rgba[3]] : [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR, $rgba[0], $rgba[1], $rgba[2]];
                }
                return null;
        }
        return null;
    ...
    protected function compileRGBAValue($value, $isAlpha = \false)
    {
        ...
        return $this->compileColorPartValue($value, 0, 255, \true);
    }
    /**
     * @param mixed     $value
     * @param int|float $min
     ...
     * @return int|mixed
     */
    protected function compileColorPartValue($value, $min, $max, $isInt = \true)
    {
        if (!\is_numeric($value)) {
            if (\is_array($value)) {
    ...
    protected function coerceString($value)
    {
        ...
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$this->compileValue($value)]];
    }
    /**
    ...
    public function assertString($value, $varName = null)
    {
        ...
        if ($value[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION) {
            $value = $this->coerceString($value);
        }
        if (!\in_array($value[0], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD])) {
            $value = $this->compileValue($value);
            throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument("{$value} is not a string.", $varName);
        }
    ...
    {
        @\trigger_error(\sprintf('"%s" is deprecated since 1.7.0.', __METHOD__), \E_USER_DEPRECATED);
        if ($value instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            if ($value->hasUnit('%')) {
    ...
    public function assertMap($value, $varName = null)
    {
        ...
        if ($map === null) {
            $value = $this->compileValue($value);
            throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument("{$value} is not a map.", $varName);
        }
        return $map;
    }
    /**
    ...
    {
        if ($value[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST || !isset($value[3]) || !\is_array($value[3])) {
    ...
    public function assertColor($value, $varName = null)
    {
        ...
        $value = $this->compileValue($value);
        throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument("{$value} is not a color.", $varName);
    }
    /**
    ...
    public function assertNumber($value, $varName = null)
    {
        if (!$value instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            $value = $this->compileValue($value);
            throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument("{$value} is not a number.", $varName);
        }
        return $value;
    }
    /**
    ...
    public function assertInteger($value, $varName = null)
    {
        ...
        if (\round($value - \intval($value), \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number::PRECISION) > 0) {
            throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument("{$value} is not an integer.", $varName);
        }
        return \intval($value);
    }
    /**
    ...
    {
        $last = \end($args);
        if (\count($args) === 3 && $last[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_EXPRESSION && $last[1] === '/') {
            \array_pop($args);
            $args[] = $last[2];
            $args[] = $last[3];
        }
    ...
    public function toHSL($red, $green, $blue)
    {
        ...
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_HSL, \fmod($h + 360, 360), $s * 100, $l / 5.1];
    }
    /**
     * Hue to RGB helper
     *
    ...
    public function toRGB($hue, $saturation, $lightness)
    {
        ...
        $out = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR, $r, $g, $b];
        return $out;
    }
    /**
     * Convert HWB to RGB
    ...
    private function RGBtoHWB($red, $green, $blue)
    {
        ...
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_HWB, \fmod($h, 360), $min / 255 * 100, 100 - $max / 255 * 100];
    }
    // Built in functions
    ...
    protected function libCall($args)
    {
        ...
        if (\in_array($functionReference[0], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD])) {
        ...
        if (!\in_array($functionReference[0], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_REFERENCE, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION])) {
            throw $this->error('Function reference expected, got ' . $functionReference[0]);
        }
        $callArgs = [[null, $args[1], \true]];
        return $this->reduce([\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_CALL, $functionReference, $callArgs]);
    }
    ...
    protected function libGetFunction($args)
    {
        ...
        if (\count($args)) {
            ...
            $isCss = $isCss === static::$true ? \true : \false;
        }
        if ($isCss) {
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION, $name, [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', []]];
        }
        return $this->getFunctionReference($name, \true);
    }
    protected static $libIf = ['condition', 'if-true', 'if-false:'];
    protected function libIf($args)
    {
        list($cond, $t, $f) = $args;
        if (!$this->isTruthy($this->reduce($cond, \true))) {
            return $this->reduce($f, \true);
        }
        return $this->reduce($t, \true);
    }
    protected static $libIndex = ['list', 'value'];
    protected function libIndex($args)
    {
        list($list, $value) = $args;
        if ($list[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP || $list[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING || $list[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD || $list[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_INTERPOLATE) {
            $list = $this->coerceList($list, ' ');
        }
        if ($list[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST) {
            return static::$null;
        }
        ...
        if ($value instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            ...
            foreach ($list[2] as $item) {
                ...
                if ($itemValue instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number && $value->equals($itemValue)) {
                    return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number($key, '');
                }
            }
            return static::$null;
        }
        ...
        return \false === $key ? static::$null : new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number($key + 1, '');
    }
    ...
    protected function libRgb($args, $kwargs, $funcName = 'rgb')
    {
        switch (\count($args)) {
            case 1:
                if (!($color = $this->coerceColor($args[0], \true))) {
                    $color = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$funcName . '(', $args[0], ')']];
                }
                break;
            case 3:
                $color = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR, $args[0], $args[1], $args[2]];
                if (!($color = $this->coerceColor($color))) {
                    $color = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$funcName . '(', $args[0], ', ', $args[1], ', ', $args[2], ')']];
                }
                return $color;
            case 2:
                if ($color = $this->coerceColor($args[0], \true)) {
                    $alpha = $this->compileRGBAValue($args[1], \true);
                    if (\is_numeric($alpha)) {
                        $color[4] = $alpha;
                    } else {
                        $color = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$funcName . '(', $color[1], ', ', $color[2], ', ', $color[3], ', ', $alpha, ')']];
                    }
                } else {
                    $color = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$funcName . '(', $args[0], ', ', $args[1], ')']];
                }
                break;
            case 4:
            default:
                $color = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR, $args[0], $args[1], $args[2], $args[3]];
                if (!($color = $this->coerceColor($color))) {
                    $color = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$funcName . '(', $args[0], ', ', $args[1], ', ', $args[2], ', ', $args[3], ')']];
                }
                break;
        }
        return $color;
    ...
    protected function alterColor(array $args, $operation, $fn)
    {
        ...
        if ($args[1][2]) {
            throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException('Only one positional argument is allowed. All other arguments must be passed by name.');
        }
        ...
        $getParam = function ($name, $max, $checkPercent = \false, $assertPercent = \false) use(&$kwargs, $scale, $change) {
            ...
            if (!$scale && $checkPercent) {
                if (!$number->hasUnit('%')) {
                    ...
                    $this->logger->warn($warning->getMessage(), \true);
                }
            }
        ...
        $saturation = $getParam('saturation', 100, \true);
        $lightness = $getParam('lightness', 100, \true);
        $whiteness = $getParam('whiteness', 100, \false, \true);
        $blackness = $getParam('blackness', 100, \false, \true);
        if (!empty($kwargs)) {
        ...
        if ($hasRgb && ($hasSL || $hasWB || $hue !== null)) {
            throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException(\sprintf('RGB parameters may not be passed along with %s parameters.', $hasWB ? 'HWB' : 'HSL'));
        }
        if ($hasWB && $hasSL) {
            throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException('HSL parameters may not be passed along with HWB parameters.');
        }
        if ($hasRgb) {
    ...
    protected function libIeHexStr($args)
    {
        ...
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [\sprintf('#%02X%02X%02X%02X', $color[4], $color[1], $color[2], $color[3])]];
    }
    ...
    protected function libRed($args)
    {
        ...
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number((int) $color[1], '');
    }
    ...
    protected function libGreen($args)
    {
        ...
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number((int) $color[2], '');
    }
    ...
    protected function libBlue($args)
    {
        ...
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number((int) $color[3], '');
    }
    protected static $libAlpha = ['color'];
    protected function libAlpha($args)
    {
        if ($color = $this->coerceColor($args[0])) {
            return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number(isset($color[4]) ? $color[4] : 1, '');
        }
    ...
    protected function libMix($args)
    {
        ...
        $weight2 = 1.0 - $weight1;
        $new = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_COLOR, $weight1 * $first[1] + $weight2 * $second[1], $weight1 * $first[2] + $weight2 * $second[2], $weight1 * $first[3] + $weight2 * $second[3]];
    ...
    protected function libHsl($args, $kwargs, $funcName = 'hsl')
    {
        $args_to_check = $args;
        if (\count($args) == 1) {
            if ($args[0][0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST || \count($args[0][2]) < 3 || \count($args[0][2]) > 4) {
                return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$funcName . '(', $args[0], ')']];
            }
            $args = $args[0][2];
        ...
        if (\count($args) === 2) {
            ...
            foreach ($args as $arg) {
                if ($arg[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION && \in_array($arg[1], ['var'])) {
                    return null;
                }
            }
            throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException('Missing argument $lightness.');
        }
        foreach ($kwargs as $arg) {
            if (\in_array($arg[0], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_CALL, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION]) && \in_array($arg[1], ['min', 'max'])) {
                return null;
            }
        }
        foreach ($args_to_check as $k => $arg) {
            ...
            if ($k >= 2 && \count($args) === 4 && \in_array($arg[0], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION_CALL, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_FUNCTION]) && \in_array($arg[1], ['calc', 'env'])) {
                return null;
            }
        }
        ...
        if (\count($args) === 4) {
            ...
            if (!$hue instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number || !$saturation instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number || !$lightness instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number || !\is_numeric($alpha)) {
                return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$funcName . '(', $args[0], ', ', $args[1], ', ', $args[2], ', ', $args[3], ')']];
            }
        } else {
            if (!$hue instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number || !$saturation instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number || !$lightness instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
                return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$funcName . '(', $args[0], ', ', $args[1], ', ', $args[2], ')']];
            }
        }
    ...
    protected function libHue($args)
    {
        $color = $this->assertColor($args[0], 'color');
        $hsl = $this->toHSL($color[1], $color[2], $color[3]);
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number($hsl[1], 'deg');
    }
    ...
    protected function libSaturation($args)
    {
        $color = $this->assertColor($args[0], 'color');
        $hsl = $this->toHSL($color[1], $color[2], $color[3]);
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number($hsl[2], '%');
    }
    ...
    protected function libLightness($args)
    {
        $color = $this->assertColor($args[0], 'color');
        $hsl = $this->toHSL($color[1], $color[2], $color[3]);
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number($hsl[3], '%');
    }
    /*
    ...
    */
    ...
    {
        $color = $this->assertColor($args[0], 'color');
        $amount = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::checkRange('amount', new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Base\Range(0, 100), $args[1], '%');
    ...
    protected function libInvert($args)
    {
        ...
        if ($value instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            if ($weight->getDimension() != 100 || !$weight->hasUnit('%')) {
                throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException('Only one argument may be passed to the plain-CSS invert() function.');
            }
            return null;
        }
    ...
    protected function libPercentage($args)
    {
        ...
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number($num->getDimension() * 100, '%');
    }
    protected static $libRound = ['number'];
    protected function libRound($args)
    {
        $num = $this->assertNumber($args[0], 'number');
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number(\round($num->getDimension()), $num->getNumeratorUnits(), $num->getDenominatorUnits());
    }
    protected static $libFloor = ['number'];
    protected function libFloor($args)
    {
        $num = $this->assertNumber($args[0], 'number');
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number(\floor($num->getDimension()), $num->getNumeratorUnits(), $num->getDenominatorUnits());
    }
    protected static $libCeil = ['number'];
    protected function libCeil($args)
    {
        $num = $this->assertNumber($args[0], 'number');
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number(\ceil($num->getDimension()), $num->getNumeratorUnits(), $num->getDenominatorUnits());
    }
    protected static $libAbs = ['number'];
    protected function libAbs($args)
    {
        $num = $this->assertNumber($args[0], 'number');
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number(\abs($num->getDimension()), $num->getNumeratorUnits(), $num->getDenominatorUnits());
    }
    ...
    {
        $list = $this->coerceList($args[0], ',', \true);
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number(\count($list[2]), '');
    }
    protected static $libListSeparator = ['list'];
    protected function libListSeparator($args)
    {
        if (!\in_array($args[0][0], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP])) {
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'space'];
        }
        ...
        if ($list[1] === ',') {
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'comma'];
        }
        if ($list[1] === '/') {
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'slash'];
        }
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'space'];
    }
    ...
    protected function libMapGet($args)
    {
        ...
        $value = static::$null;
        foreach ($keys as $key) {
            if (!\is_array($map) || $map[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP) {
                return static::$null;
            }
    ...
    protected function libMapKeys($args)
    {
        $map = $this->assertMap($args[0], 'map');
        $keys = $map[1];
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', $keys];
    }
    ...
    protected function libMapValues($args)
    {
        $map = $this->assertMap($args[0], 'map');
        $values = $map[2];
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', $values];
    }
    ...
    protected function libMapHasKey($args)
    {
        ...
        foreach ($keys as $key) {
            ...
            if ($value === null || $value instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number || $value[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP) {
                return self::$false;
            }
            $map = $value;
        }
    ...
    protected function libMapMerge($args)
    {
        ...
        $map2 = $args[1];
        $keys = [];
        if ($map2[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST && isset($map2[3]) && \is_array($map2[3])) {
            // This is an argument list for the variadic signature
            if (\count($map2[2]) === 0) {
                throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException('Expected $args to contain a key.');
            }
            if (\count($map2[2]) === 1) {
                throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException('Expected $args to contain a value.');
            }
            $keys = $map2[2];
            $map2 = \array_pop($keys);
        }
     ...
     */
    private function modifyMap(array $map, array $keys, callable $modify, $addNesting = \true)
    {
        if ($keys === []) {
            return $modify($map);
        }
    ...
    protected function libKeywords($args)
    {
        ...
        if ($value[0] !== \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST || !isset($value[3]) || !\is_array($value[3])) {
            $compiledValue = $this->compileValue($value);
            throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument($compiledValue . ' is not an argument list.', 'args');
        }
        $keys = [];
        $values = [];
        foreach ($this->getArgumentListKeywords($value) as $name => $arg) {
            $keys[] = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, $name];
            $values[] = $arg;
        }
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_MAP, $keys, $values];
    }
    ...
    protected function libJoin($args)
    {
        ...
        $list1 = $this->coerceList($list1, ' ', \true);
        $list2 = $this->coerceList($list2, ' ', \true);
        switch ($this->compileStringContent($this->assertString($sep, 'separator'))) {
            ...
            case 'auto':
                ...
                break;
            default:
                throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument('Must be "space", "comma", "slash", or "auto".', 'separator');
        }
        if ($bracketed === static::$true) {
            $bracketed = \true;
        } elseif ($bracketed === static::$false) {
            $bracketed = \false;
        } elseif ($bracketed === [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'auto']) {
            $bracketed = 'auto';
        ...
        $res = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, $separator, \array_merge($list1[2], $list2[2])];
        if ($bracketed) {
    ...
    protected function libAppend($args)
    {
        ...
        $res = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, $separator, \array_merge($list1[2], [$value])];
    ...
    protected function libZip($args)
    {
        ...
        $result = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', $lists];
        if (!\is_null($firstList)) {
            foreach ($firstList[2] as $key => $item) {
                $list = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ' ', [$item]];
    ...
    {
        $value = $args[0];
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, $this->getTypeOf($value)];
    }
    /**
     * @param array|Number $value
     *
    ...
    {
        $num = $this->assertNumber($args[0], 'number');
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '"', [$num->unitStr()]];
    }
    ...
    protected function libComparable($args)
    {
        ...
        if (!$number1 instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number || !$number2 instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
    ...
    protected function libStrIndex($args)
    {
        ...
        if (!\strlen($substringContent)) {
            ...
            $result = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbStrpos($stringContent, $substringContent);
        }
        return $result === \false ? static::$null : new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number($result + 1, '');
    }
    ...
    protected function libStrInsert($args)
    {
        ...
        if ($index < 0) {
            $index = \max(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbStrlen($stringContent) + 1 + $index, 0);
        }
        $string[2] = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbSubstr($stringContent, 0, $index), $insertContent, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbSubstr($stringContent, $index)];
        return $string;
    }
    ...
    protected function libStrLength($args)
    {
        $string = $this->assertString($args[0], 'string');
        $stringContent = $this->compileStringContent($string);
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbStrlen($stringContent), '');
    }
    ...
    protected function libStrSlice($args)
    {
        ...
        if ($endInt === 0) {
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, $string[1], []];
        }
        if ($startInt > 0) {
            $startInt--;
        }
        if ($endInt < 0) {
            $endInt = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbStrlen($stringContent) + $endInt;
        } else {
            $endInt--;
        }
        if ($endInt < $startInt) {
        ...
        // The end of the slice is inclusive
        $string[2] = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbSubstr($stringContent, $startInt, $length)];
        return $string;
    }
    ...
    {
        $mblength = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbStrlen($stringContent);
        if ($mblength === \strlen($stringContent)) {
            return $filter($stringContent);
        }
        $filteredString = "";
        for ($i = 0; $i < $mblength; $i++) {
            $char = \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Util::mbSubstr($stringContent, $i, 1);
            if (\strlen($char) > 1) {
                $filteredString .= $char;
            } else {
    ...
    protected function libCounter($args)
    {
        ...
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', ['counter(' . \implode(',', $list) . ')']];
    }
...
TXT;
                \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Warn::deprecation($this->addLocationToMessage($message));
            }
            $n = $this->assertInteger($limit, 'limit');
            if ($n < 1) {
                throw new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException("\$limit: Must be greater than 0, was {$n}.");
            }
            return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number(\mt_rand(1, $n), '');
        }
        $max = \mt_getrandmax();
        return new \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number(\mt_rand(0, $max - 1) / $max, '');
    }
    ...
    protected function libUniqueId()
    {
        ...
        $id += \mt_rand(0, 10) + 1;
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', ['u' . \str_pad(\base_convert($id, 10, 36), 8, '0', \STR_PAD_LEFT)]];
    }
    /**
     * @param array|Number $value
    ...
    protected function inspectFormatValue($value, $force_enclosing_display = \false)
    {
        if ($value === static::$null) {
            $value = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD, 'null'];
        }
        $stringValue = [$value];
        if ($value instanceof \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Node\Number) {
            return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', $stringValue];
        }
        if ($value[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST) {
            if (\end($value[2]) === static::$null) {
                \array_pop($value[2]);
                $value[2][] = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', ['']];
                $force_enclosing_display = \true;
            }
    ...
    protected function getSelectorArg($arg, $varname = null, $allowParent = \false)
    {
        ...
        if (!$this->checkSelectorArgType($arg)) {
            ...
            throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument("{$var_value} is not a valid selector: it must be a string, a list of strings, or a list of lists of strings", $varname);
        }
        if ($arg[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING) {
            $arg[1] = '';
        }
        $arg = $this->compileValue($arg);
        $parsedSelector = [];
        if ($parser->parseSelector($arg, $parsedSelector, \true)) {
                ...
                foreach ($gluedSelector as $selector) {
                    foreach ($selector as $s) {
                        if (\in_array(static::$selfSelector, $s)) {
                            throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument("Parent selectors aren't allowed here.", $varname);
                        }
                    }
                }
            }
        ...
        throw \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Exception\SassScriptException::forArgument("expected more input, invalid selector.", $varname);
    }
    /**
    ...
    {
        if ($arg[0] === \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST && $maxDepth > 0) {
        ...
        if (!\in_array($arg[0], [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_KEYWORD])) {
            return \false;
        }
        return \true;
    }
    ...
    protected function libSelectorReplace($args)
    {
        ...
        $replaced = $this->extendOrReplaceSelectors($selectors, $original, $replacement, \true);
    ...
    protected function libSelectorNest($args)
    {
        ...
        $selectorsMap = [];
        foreach ($args as $arg) {
            $selectorsMap[] = $this->getSelectorArg($arg, 'selector', \true);
        }
    ...
    protected function libSimpleSelectors($args)
    {
        ...
        $listParts = [];
        foreach ($part as $p) {
            $listParts[] = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '', [$p]];
        }
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', $listParts];
    }
    protected static $libScssphpGlob = ['pattern'];
    protected function libScssphpGlob($args)
    {
        @\trigger_error(\sprintf('The "scssphp-glob" function is deprecated an will be removed in ScssPhp 2.0. Register your own alternative through "%s::registerFunction', __CLASS__), \E_USER_DEPRECATED);
        $this->logger->warn('The "scssphp-glob" function is deprecated an will be removed in ScssPhp 2.0.', \true);
        ...
        foreach ($matches as $match) {
            ...
            $listParts[] = [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_STRING, '"', [$match]];
        }
        return [\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Type::T_LIST, ',', $listParts];
    }
}
