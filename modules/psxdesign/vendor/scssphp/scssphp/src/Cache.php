...
class Cache
{
    ...
    {
        $t = ['version' => self::CACHE_VERSION, 'scssphpVersion' => \PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Version::VERSION, 'operation' => $operation, 'what' => $what, 'options' => $options];
