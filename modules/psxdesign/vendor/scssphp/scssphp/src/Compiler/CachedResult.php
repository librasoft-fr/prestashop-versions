 ...
 */
namespace PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\Compiler;
...
class CachedResult
{
     ...
     */
    public function __construct(\PrestaShop\Module\PsxDesign\Vendor\ScssPhp\ScssPhp\CompilationResult $result, array $parsedFiles, array $resolvedImports)
    {
        $this->result = $result;
