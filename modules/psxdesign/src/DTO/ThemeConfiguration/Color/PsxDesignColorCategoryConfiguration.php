...
class PsxDesignColorCategoryConfiguration
{
    /**
     * @var string
     */
    ...
    /**
     * @param array $colorCategoryConfiguration
     *
     * @return PsxDesignColorCategoryConfiguration
     */
    public static function createFromThemeConfiguration(array $colorCategoryConfiguration): self
    {
        $parameterBag = new ParameterBag($colorCategoryConfiguration);
