 ...
 */
const{$:o}=window,i=0,l=1,s=2,r=3,a=4,n=5,d=6,p=7,h=8;class c{constructor(){o(".js-entity-select").on("change",(()=>this.toggleForm())),this.toggleForm()}toggleForm(){const e=o("#entity").find("option:selected"),t=parseInt(e.val(),10),i=e.text().toLowerCase();this.toggleEntityAlert(t),this.toggleFields(t,i),this.loadAvailableFields(t)}toggleEntityAlert(e){const t=o(".js-entity-alert");[i,l].includes(e)?t.show():t.hide()}toggleFields(e,t){const c=o(".js-truncate-form-group"),m=o(".js-match-ref-form-group"),f=o(".js-regenerate-form-group"),F=o(".js-force-ids-form-group"),u=o(".js-entity-name");h===e?c.hide():c.show(),[l,s].includes(e)?m.show():m.hide(),[i,l,n,d,h].includes(e)?f.show():f.hide(),[i,l,r,a,n,d,h,p].includes(e)?F.show():F.hide(),u.html(t)}loadAvailableFields(e){const t=o(".js-available-fields");o.ajax({url:t.data("url"),data:{entity:e},dataType:"json"}).then((e=>{this.removeAvailableFields(t);for(let o=0;o<e.length;o+=1)this.appendAvailableField(t,e[o].label+(e[o].required?"*":""),e[o].description);t.find('[data-toggle="popover"]').popover()}))}removeAvailableFields(e){e.find('[data-toggle="popover"]').popover("hide"),e.empty()}appendHelpBox(e,t){const i=o(".js-available-field-popover-template").clone();i.attr("data-content",t),i.removeClass("js-available-field-popover-template d-none"),e.append(i)}appendAvailableField(e,t,i){const l=o(".js-available-field-template").clone();l.text(t),i&&this.appendHelpBox(l,i),l.removeClass("js-available-field-template d-none"),l.appendTo(e)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
