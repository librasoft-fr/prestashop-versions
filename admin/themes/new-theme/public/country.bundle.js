 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;$t((()=>{const t=new C("country");t.addExtension(new B),t.addExtension(new T),t.addExtension(new S),t.addExtension(new L),t.addExtension(new F),t.addExtension(new Ct),t.addExtension(new Ot),t.addExtension(new Bt),t.addExtension(new Mt),t.addExtension(new Lt),new Tt}))})(),window.country=o})();