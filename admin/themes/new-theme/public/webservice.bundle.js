 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Et}=window;class Ot{constructor(){return Et('input[id^="webservice_key_permissions_all"]').on("change",(t=>{const e=Et(t.currentTarget),n=e.is(":checked");e.closest("tr").find(`input:not(input[id="${e.attr("id")}"])`).each(((t,e)=>{Et(e).prop("checked",n)}))})),{}}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
