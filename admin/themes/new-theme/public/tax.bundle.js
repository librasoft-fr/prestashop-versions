 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:j}=window,B=function(t,e){j.post(t).then((()=>window.location.assign(e)))},{$:M}=window;class A{extend(t){t.getContainer().on("click",p,(t=>{B(M(t.currentTarget).data("url"),M(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class T{extend(t){t.getHeaderContainer().on("click",y,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Tt{extend(t){const e=t.getContainer().find(b);e.find(g).prop("disabled",!0),e.find(w).on("input dp.change",(()=>{e.find(g).prop("disabled",!1),e.find(v).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Pt}=window;Pt((()=>{const e=new x("tax");e.addExtension(new jt),e.addExtension(new T),e.addExtension(new O),e.addExtension(new A),e.addExtension(new $),e.addExtension(new Ct),e.addExtension(new xt),e.addExtension(new Lt),e.addExtension(new Tt),e.addExtension(new $t),new Ft,new At,window.prestashop.component.initComponents(["MultistoreConfigField"]),Pt(t.useEcoTax).on("change",(e=>{const n=Number(Pt(e.currentTarget).val());Pt(t.rowEcoTaxRuleGroup).toggleClass("d-none",0===n)}))}))})(),window.tax=o})();