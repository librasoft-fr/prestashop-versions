 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class T{extend(t){const e=t.getContainer().find(f);new j(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Tt}=window;class At{extend(t){t.getHeaderContainer().on("click",a.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",a.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=Tt(a.showModalForm(t.getId()));this.fillExportForm(e,t);const n=Tt(a.showModalGrid(t.getId()));n.modal("show"),n.on("click",E,(()=>e.submit()))}onExportSqlManagerClick(t){const e=Tt(a.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const n=e.getContainer().find(l).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=Tt(b).find(p);let e="";return t.each(((t,n)=>{const o=Tt(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;$t((()=>{["manufacturer","manufacturer_address"].forEach((t=>{const e=new B(t);e.addExtension(new At),e.addExtension(new $),e.addExtension(new T),e.addExtension(new L),e.addExtension(new P),e.addExtension(new Et),e.addExtension(new Bt),e.addExtension(new jt),e.addExtension(new Mt),e.addExtension(new Lt)})),window.prestashop.component.initComponents(["TranslatableInput","TranslatableField","TinyMCEEditor"]),new window.prestashop.component.TaggableField({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new window.prestashop.component.ChoiceTree("#manufacturer_shop_association").enableAutoCheckChildren(),new i}))})(),window.manufacturer=o})();